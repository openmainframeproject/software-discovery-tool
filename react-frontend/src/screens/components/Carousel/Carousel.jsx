...
function Carousel() {
  const settings = {
    dots: false,
    infinite: true,
    speed: 2000, // Slow down the speed for a smoother effect
    slidesToShow: 4, // Adjust this number as needed
    slidesToScroll: 1,
    autoplay: true,
    autoplaySpeed: 0, // Continuous autoplay without a pause
    cssEase: 'linear', // Continuous linear sliding
    arrows: false,
    responsive: [
      {
        breakpoint: 1024,
  ...
  return (
    <div className="support-section">
      <div className="supported-for">
        <div className="supported-for-1">SUPPORTED FOR</div>
      </div>
